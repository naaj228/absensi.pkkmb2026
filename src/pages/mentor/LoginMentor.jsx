...
<span className="bg-primary/20 text-primary-fixed-dim px-3 py-1 rounded-full text-label-md font-semibold tracking-wider uppercase">Portal Mentor</span>
<h1 className="text-display-lg font-bold font-display-lg leading-tight">Kelola Kehadiran Gugus</h1>
</div>
...
<h2 className="text-headline-lg font-bold font-display-lg text-on-surface tracking-tight" id="login-title">Login Mentor</h2>
</div>
<form className="space-y-6" onSubmit={handleLoginSubmit}>
<div className="space-y-5">
{/* NIM Input */}
<div>
<label className="block text-label-md font-label-md text-on-surface mb-2" htmlFor="nim">Email Mentor</label>
...
<input className="w-full pl-12 pr-4 py-4 bg-surface rounded-xl border border-outline-variant/50 text-body-md font-body-md text-on-surface focus:outline-none focus:border-primary focus:ring-4 focus:ring-primary/10 transition-all placeholder:text-on-surface-variant/30" id="nim" name="username" placeholder="Masukkan email mentor Anda..." required type="text" value={nim} onChange={(e) => setNim(e.target.value)} />
</div>
</div>
{/* Password Input */}
<div>
