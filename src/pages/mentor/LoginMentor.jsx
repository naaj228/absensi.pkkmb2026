...
{/* NIM Input */}
<div>
<label className="block text-label-md font-label-md text-on-surface mb-2" htmlFor="nim">Email / NIP</label>
...
<input className="w-full pl-12 pr-4 py-4 bg-surface rounded-xl border border-outline-variant/50 text-body-md font-body-md text-on-surface focus:outline-none focus:border-primary focus:ring-4 focus:ring-primary/10 transition-all placeholder:text-on-surface-variant/30" id="nim" name="username" placeholder="Masukkan email atau NIP Anda..." required type="text" value={nim} onChange={(e) => setNim(e.target.value)} />
</div>
</div>
{/* Password Input */}
<div>
